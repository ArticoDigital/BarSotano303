...
while (have_posts()) : the_post(); ?>
    <section class="contacto">
        <h3>Contáctenos</h3>
        <p>¿Tiene algo que contarnos? aqui puedes contarnos tu experiencia, felicitarnos, proponernos y dart u punto de vista. para nosotros es muy importante saber lo que piensas.</p>
        <?php the_content() ?>
